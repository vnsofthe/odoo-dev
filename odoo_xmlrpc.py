...
for i in ids:
   ...
   s_ids = s_sock.execute(s_dbname, s_uid, s_pwd, 'ir.translation', 'search', [("lang","=","zh_CN"),("src","=",data['src']),("display_name","=",data['display_name']),("name","=",data['name']),("type","=",data['type']),("module","=",data['module'])])
   if not s_ids:
      s_ids=s_sock.execute(s_dbname,s_uid,s_pwd,'ir.translation','search',[("lang","=","zh_CN"),("src","=",data['src']),("type","=",data['type'])])
   if not s_ids:
      s_ids=s_sock.execute(s_dbname,s_uid,s_pwd,'ir.translation','search',[("lang","=","zh_CN"),("src","=",data['src'])])
   if s_ids:
