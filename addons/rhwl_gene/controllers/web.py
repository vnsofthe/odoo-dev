...
content_m={"0":[("前言",1,1),("致辞",2,2),("个人信息",3,3),("基因检测报告的说明",8),("健康综合评估和指导建议",13),("健康遗传易感性评估及结果分析",35),("基因检测报告的附录",273)],
           "8":[("服务项目介绍",8,8),("检测报告解读示例",9,12)],
           "13":[("肿瘤专项相关疾病预防",14),("代谢与营养能力相关疾病预防",19),("心脑血管疾病相关疾病预防",23),("呼吸、消化、泌尿系统疾病相关疾病预防",27),("皮肤、肌肉和骨关节相关疾病预防",31),("精神和行为障碍相关疾病预防",34)],
...
content_f={"0":[("前言",1,1),("致辞",2,2),("个人信息",3,3),("基因检测报告的说明",8),("健康综合评估和指导建议",13),("健康遗传易感性评估及结果分析",35),("基因检测报告的附录",273)],
           "8":[("服务项目介绍",8,8),("检测报告解读示例",9,12)],
           "13":[("肿瘤专项相关疾病预防",14),("代谢与营养能力相关疾病预防",19),("心脑血管疾病相关疾病预防",23),("呼吸、消化、泌尿系统疾病相关疾病预防",27),("皮肤、肌肉和骨关节相关疾病预防",31),("精神和行为障碍相关疾病预防",34)],
           "14":[("高危警示",14,14),("易感性综合评估",15,16),("环境风险因素分析与指导",17,18)],
           "19":[("高危警示",19,19),("易感性综合评估",20,21),("环境风险因素分析与指导",22,22)],
