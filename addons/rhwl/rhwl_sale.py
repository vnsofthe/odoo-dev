    ...
    def action_sms(self,cr,uid,ids,context=None):
        for i in self.browse(cr,uid,ids,context=context):
            if i.check_state=="ok":
                ...
                str = u"尊敬的%s女士：您好，恭喜您！您编号为%s的无创产基因检测结果在我们的检测范围内未见异常（阴性）。感谢您的耐心等待，请您收到短信于5个工作日后去医院领取您的检测报告，已提前办理好检测报告邮寄服务的孕妇，请耐心等待快件投递，祝您好孕！如有疑问，欢迎拨打400-6060-610客服电话咨询（检测结果仅供临床参考，孕期产检请遵医嘱）" % (i.yfxm,i.name)
